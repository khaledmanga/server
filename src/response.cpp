...
const std::string& StatusLine::version() const noexcept {
    return version_;
}

int StatusLine::statusCode() const noexcept {
    return status_code_;
}
...
std::size_t Headers::contentLength() const noexcept {
    return content_length_;
}

const std::string& Headers::date() const noexcept {
    return date_;
}

const std::string& Headers::server() const noexcept {
    return server_;
}

const std::string& Headers::connection() const noexcept {
    return connection_;
}
...
const StatusLine& Response::statusLine() const noexcept {
    return status_line_;
}
